...
class SalesPerson < Person
 ...
 x = SalesPerson.new()
puts x.check_private_method_implicit_receiver
puts x.check_private_method_explicit_receiver
puts x.check_protected_method_implicit_receiver
puts x.check_protected_method_explicit_receiver